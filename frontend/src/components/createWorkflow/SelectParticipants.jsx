...
const SelectParticipants = ({ handleNext }) => {
        ...
        voteInfo.participantData === null && (
          <FillDiv>
            ...
            <TextField
              ...
              variant="standard"
              onKeyDown={(e) => {
                if (e.key === "Enter" && voteInfo.numParticipants !== 0) {
                  e.preventDefault();
              ...
              onChange={(e) => {
                ...
                if (val % 1 === 0 && val[val.length - 1] !== ".") {
                  setVoteInfo({
                    ...voteInfo,
                    numParticipants: val === "" ? 0 : parseInt(val),
                  });
                }
              }}
            />
          ...
          <FillDiv>
            ...
            <label htmlFor="file">
              <Input
                ...
                type="file"
                onChange={(e) =>
                  txtUploadHandler(e, voteInfo, setVoteInfo, "participantData")
                }
              />
              <Button
                sx={buttonGroupSX(10)}
