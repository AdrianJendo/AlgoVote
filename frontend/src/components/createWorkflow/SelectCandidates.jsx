...
const SelectCandidates = ({ handleNext }) => {
  const [voteInfo, setVoteInfo] = useContext(VoteInfoContext);

  const goBack = () => {
    if (voteInfo.candidateData && voteInfo.candidateUploadMethod === "manual") {
      setVoteInfo({
        ...voteInfo,
        candidateData: null,
    ...
    <div style={{ position: "relative", height: "100%" }}>
      ...
      {voteInfo.candidateUploadMethod === "file" &&
        voteInfo.candidateUploadType === null && (
          <FillDiv>
            <Typography sx={typographySX(4)}>Select a file type</Typography>
          ...
          <FillDiv>
                    ...
                    <div>
                      <center>
                        <Typography variant="caption">
                          Example of valid format shown below:
                        </Typography>
                      </center>
            ...
            <label htmlFor="file">
              <Input
                ...
                type="file"
                onChange={(e) =>
                  excelUploadHandler(e, voteInfo, setVoteInfo, "candidateData")
                }
              />
              <Button
                sx={buttonGroupSX(10)}
          ...
          <FillDiv>
            ...
            <label htmlFor="file">
              <Input
                ...
                type="file"
                onChange={(e) =>
                  txtUploadHandler(e, voteInfo, setVoteInfo, "candidateData")
                }
              />
              <Button
                sx={buttonGroupSX(10)}
